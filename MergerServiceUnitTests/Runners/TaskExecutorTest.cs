...
namespace MergerLogicUnitTests.Utils
{
  ...
  public class TaskExecutorTest
  {
    ...
    public void BeforeEach()
    {
      ...
      this._testTileMerger = new TileMerger(_tileScalerMock.Object, _tileMergerLoggerMock.Object, _configurationManagerMock.Object);
    ...
    public void WhenConfiguringBatchLimits_ShouldWriteTilesEachTimeAfterReachingBatchLimit(bool limitBatchSize, int batchMaxSize, long batchMaxBytes, int amountOfFlushes, int totalAmountOfTiles)
    {
      ...
      Tile[] testSourceTiles = testSourceCoords.Select(coord => new Tile(_configurationManagerMock.Object, coord, tileBytes)).ToArray();
    ...
    private Tuple<MergeTask, Mock<IData>, Tile[]> SetupTestTask(int amountOfSources, bool isTargetNew)
    {
      ...
      Tile testTargetTile = new Tile(_configurationManagerMock.Object, testTargetCoord, tileBytes);
      Tile[] testSourcesTiles = testSourceCoords.Select(coord => new Tile(_configurationManagerMock.Object, coord, tileBytes)).ToArray();
