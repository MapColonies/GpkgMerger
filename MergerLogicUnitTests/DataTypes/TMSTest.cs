...
namespace MergerLogicUnitTests.DataTypes
{
    ...
    public class TMSTest
    {
        ...
        public void TileExists(Coord cords, bool isOneXOne, GridOrigin origin, bool useCoords)
        {
            ...
            if (useCoords)
            {
                Assert.AreEqual(expected, tmsSource.TileExists(cords, null));
            }
            else
            {
        ...
        public void GetCorrespondingTileWithoutUpscaleWithoutConversion(int batchSize, int z, int x, int y, bool expectedNull)
        {
            ...
            Assert.AreEqual(expectedNull ? null : existingTile, tmsSource.GetCorrespondingTile(cords, null, false));
        ...
        public void GetCorrespondingTileWithoutUpscale(Coord cords, bool enableUpscale, bool isOneXOne, GridOrigin origin)
        {
            ...
            var res = tmsSource.GetCorrespondingTile(cords, null, enableUpscale);
            if (expectedNull)
            {
                Assert.IsNull(res);
            }
        ...
        public void GetCorrespondingTileWithUpscale(bool isOneXOne, GridOrigin origin, bool isValidConversion)
        {
            ...
            Assert.AreEqual(expectedTile, tmsSource.GetCorrespondingTile(upscaleCords, null, true));
            if (origin != GridOrigin.LOWER_LEFT)
            {
        ...
        public void Reset(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            tmsSource.GetNextBatch(out string batchIdentifier, out string? _, null);
            tmsSource.GetNextBatch(out batchIdentifier, out string? _, null);
