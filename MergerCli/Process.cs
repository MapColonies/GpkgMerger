...
namespace MergerCli
{
    internal class Process : IProcess
    {
        ...
        private void DoWork(TileFormat targetFormat, IData baseData, IData newData, List<Tile> newTiles, BatchStatusManager batchStatusManager, ref long tileProgressCount, long totalTileCount,ref bool pollForBatch)
        {
            ...
            BatchStatusManager batchStatusManager, long tileProgressCount, long totalTileCount, string? resumeBatchIdentifier, bool resumeMode,bool pollForBatch)
        {
            ...
            Parallel.For(0, numOfThreads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, _ =>
            {
                while (tileProgressCount != totalTileCount)
                {
                    ...
                    DoWork(targetFormat, baseData, newData, batchResult.newTiles, batchStatusManager, ref tileProgressCount,
