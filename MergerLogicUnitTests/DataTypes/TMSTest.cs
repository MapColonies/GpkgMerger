...
namespace MergerLogicUnitTests.DataTypes
{
    ...
    public class TMSTest
    {
        ...
        public void TileExists(Coord cords, bool isOneXOne, GridOrigin origin, bool useCoords)
        {
            ...
            var tmsSource = new TMS(this._serviceProviderMock.Object, this._metricsProviderMock.Object, "test", 10, extent, grid, origin, 21, 0);

            var expected = cords.Z == 2;
            if (useCoords)
            {
                Assert.AreEqual(expected, tmsSource.TileExists(cords));
            }
            else
            {
                var tile = new Tile(cords, new byte[] { });
                Assert.AreEqual(expected, tmsSource.TileExists(tile));
            }
        ...
        public void GetCorrespondingTileWithoutUpscaleWithoutConversion(int batchSize, int z, int x, int y, bool expectedNull)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var tmsSource = new TMS(this._serviceProviderMock.Object, this._metricsProviderMock.Object,"test", batchSize, extent, Grid.TwoXOne, GridOrigin.LOWER_LEFT, 21, 0);
        ...
        public void TileCount(bool isOneXOne, GridOrigin origin)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            Grid grid = isOneXOne ? Grid.OneXOne : Grid.TwoXOne;
            var tmsSource = new TMS(this._serviceProviderMock.Object, this._metricsProviderMock.Object,"test", 10, extent, grid, origin, 3, 0);
        ...
        public void Reset(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            Grid grid = isOneXOne ? Grid.OneXOne : Grid.TwoXOne;
            var tmsSource = new TMS(this._serviceProviderMock.Object, this._metricsProviderMock.Object,"test", batchSize, extent, grid, origin, 21, 0);
        ...
        public void GetNextBatch(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            Grid grid = isOneXOne ? Grid.OneXOne : Grid.TwoXOne;
            var tmsSource = new TMS(this._serviceProviderMock.Object, this._metricsProviderMock.Object,"test", batchSize, extent, grid, origin, maxZoom, minZoom);
