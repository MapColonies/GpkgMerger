...
namespace MergerLogicUnitTests.DataTypes
{
    ...
    public class TMSTest
    {
        ...
        public void TileExists(Coord cords, bool isOneXOne, GridOrigin origin, bool useCoords)
        {
            ...
            var tmsSource = new TMS(this._serviceProviderMock.Object, "test", 10, extent, isOneXOne, origin, 21, 0);
        ...
        public void GetCorrespondingTileWithoutUpscaleWithoutConversion(int batchSize, int z, int x, int y, bool expectedNull)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var tmsSource = new TMS(this._serviceProviderMock.Object, "test", batchSize, extent, false, GridOrigin.UPPER_LEFT, 21, 0);
        ...
        public void TileCount(bool isOneXOne, GridOrigin origin)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var tmsSource = new TMS(this._serviceProviderMock.Object, "test", 10, extent, isOneXOne, origin, 3, 0);
        ...
        public void Reset(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var tmsSource = new TMS(this._serviceProviderMock.Object, "test", batchSize, extent, isOneXOne, origin, 21, 0);
        ...
        public void GetNextBatch(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            var tmsSource = new TMS(this._serviceProviderMock.Object, "test", batchSize, extent, isOneXOne, origin, maxZoom, minZoom);
            ...
            for (int i = 0; i < tileBatches.Count; i++)
            {
                ...
                var res = tmsSource.GetNextBatch(out string batchIdentifier);
