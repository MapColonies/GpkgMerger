...
namespace MergerLogicUnitTests.DataTypes
{
    ...
    public class WMTSTest
    {
        ...
        public void TileExists(Coord cords, bool isOneXOne, GridOrigin origin, bool useCoords)
        {
            ...
            var wmtsSource = new WMTS(this._serviceProviderMock.Object, "test", 10, extent, isOneXOne, origin, 21, 0);
        ...
        public void GetCorrespondingTileWithoutUpscaleWithoutConversion(int batchSize, int z, int x, int y, bool expectedNull)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var wmtsSource = new WMTS(this._serviceProviderMock.Object, "test", batchSize, extent, false, GridOrigin.UPPER_LEFT, 21, 0);
        ...
        public void TileCount(bool isOneXOne, GridOrigin origin)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var wmtsSource = new WMTS(this._serviceProviderMock.Object, "test", 10, extent, isOneXOne, origin, 3, 0);
        ...
        public void Reset(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            var extent = new Extent() { MinX = -180, MinY = -90, MaxX = 180, MaxY = 90 };
            var wmtsSource = new WMTS(this._serviceProviderMock.Object, "test", batchSize, extent, isOneXOne, origin, 21, 0);
        ...
        public void GetNextBatch(bool isOneXOne, GridOrigin origin, int batchSize)
        {
            ...
            var wmtsSource = new WMTS(this._serviceProviderMock.Object, "test", batchSize, extent, isOneXOne, origin, maxZoom, minZoom);
