...
namespace MergerLogicUnitTests.ImageProcessing
{
    ...
    public class ImageFormatterTest
    {
        ...
        public void ConvertToFormat(string testTileBytesBase64, TileFormat testTileFormat, string expectedTileBytesBase64)
        {
            var testTile = new Tile(new Coord(0, 0, 0), Convert.FromBase64String(testTileBytesBase64));
            var resultTile = this._testImageFormatter.ConvertToFormat(testTile, testTileFormat);
